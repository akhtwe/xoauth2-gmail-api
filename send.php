...
if (!$mail->send()) {
    echo '<h3 style="color:red;padding-top:30px;">Mailer Error:<h3> ' . $mail->ErrorInfo;
} else {
    echo '<h3 style="color:green;text-align:center;padding-top:30px;"> Message sent!</h3>';
    echo "<a href='/' > <b>Back</b></a>";
}